...
const createPointTemplate = (point, offers, destinations) => {
  ...
  return (
    `<li class="trip-events__item">
              <div class="event">
                <time class="event__date" datetime="2019-03-18">${getFormattedDayFromDate(dateFrom)}</time>
                ...
                <div class="event__schedule">
                  <p class="event__time">
                    ...
                    &mdash;
                    <time class="event__end-time" datetime="2019-03-18T11:00">${getFormattedTimeFromDate(dateTo)}</time>
                  </p>
